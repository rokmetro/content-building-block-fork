...
type Services interface {
	...
	GetFileContentUploadURLs(claims *tokenauth.Claims, fileNames []string, entityID string, category string, handleDuplicateFileNames bool) ([]model.FileContentItemRef, error)
